...
export declare function V1ContainerFromJSON(json: any): V1Container;
export declare function V1ContainerFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Container;
export declare function V1ContainerToJSON(value?: V1Container | null): any;

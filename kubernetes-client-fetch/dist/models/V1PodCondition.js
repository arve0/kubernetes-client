...
exports.V1PodConditionToJSON = exports.V1PodConditionFromJSONTyped = exports.V1PodConditionFromJSON = void 0;
const runtime_1 = require("../runtime");
function V1PodConditionFromJSON(json) {
    return V1PodConditionFromJSONTyped(json, false);
}
exports.V1PodConditionFromJSON = V1PodConditionFromJSON;
function V1PodConditionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.V1PodConditionFromJSONTyped = V1PodConditionFromJSONTyped;
function V1PodConditionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.V1PodConditionToJSON = V1PodConditionToJSON;

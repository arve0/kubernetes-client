 ...
 */
import { V1Capabilities, V1SELinuxOptions, V1SeccompProfile, V1WindowsSecurityContextOptions } from './';
/**
...
export declare function V1SecurityContextToJSON(value?: V1SecurityContext | null): any;

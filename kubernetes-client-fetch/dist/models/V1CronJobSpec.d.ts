...
export declare function V1CronJobSpecFromJSON(json: any): V1CronJobSpec;
export declare function V1CronJobSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1CronJobSpec;
export declare function V1CronJobSpecToJSON(value?: V1CronJobSpec | null): any;

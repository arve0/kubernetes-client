 ...
 */
import { V1Affinity, V1Container, V1EphemeralContainer, V1HostAlias, V1LocalObjectReference, V1PodDNSConfig, V1PodOS, V1PodReadinessGate, V1PodSecurityContext, V1Toleration, V1TopologySpreadConstraint, V1Volume } from './';
/**
...
export declare function V1PodSpecFromJSON(json: any): V1PodSpec;
export declare function V1PodSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1PodSpec;
export declare function V1PodSpecToJSON(value?: V1PodSpec | null): any;

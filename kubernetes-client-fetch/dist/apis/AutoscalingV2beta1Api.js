...
exports.AutoscalingV2beta1Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class AutoscalingV2beta1Api extends runtime.BaseAPI {
    /**
    ...
    createNamespacedHorizontalPodAutoscalerRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: models_1.V2beta1HorizontalPodAutoscalerToJSON(requestParameters.body),
            });
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V2beta1HorizontalPodAutoscalerFromJSON(jsonValue));
        });
    }
    /**
     * create a HorizontalPodAutoscaler
    ...
    listHorizontalPodAutoscalerForAllNamespacesRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V2beta1HorizontalPodAutoscalerListFromJSON(jsonValue));
        });
    }
    /**
     * list or watch objects of kind HorizontalPodAutoscaler

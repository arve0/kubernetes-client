...
exports.NodeV1Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class NodeV1Api extends runtime.BaseAPI {
    /**
    ...
    createRuntimeClassRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: models_1.V1RuntimeClassToJSON(requestParameters.body),
            });
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V1RuntimeClassFromJSON(jsonValue));
        });
    }
    /**
     * create a RuntimeClass
    ...
    listRuntimeClassRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V1RuntimeClassListFromJSON(jsonValue));
        });
    }
    /**
     * list or watch objects of kind RuntimeClass

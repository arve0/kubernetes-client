...
class DiscoveryV1Api extends runtime.BaseAPI {
    ...
    createNamespacedEndpointSliceRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: models_1.V1EndpointSliceToJSON(requestParameters.body),
            });
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V1EndpointSliceFromJSON(jsonValue));
        });
    }
    /**
     * create an EndpointSlice
    ...
    listEndpointSliceForAllNamespacesRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V1EndpointSliceListFromJSON(jsonValue));
        });
    }
    /**
     * list or watch objects of kind EndpointSlice

...
exports.EventsV1Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class EventsV1Api extends runtime.BaseAPI {
    /**
     * create an Event
     */
    createNamespacedEventRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: models_1.EventsV1EventToJSON(requestParameters.body),
            });
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.EventsV1EventFromJSON(jsonValue));
        });
    }
    /**
     * create an Event
    ...
    listEventForAllNamespacesRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.EventsV1EventListFromJSON(jsonValue));
        });
    }
    /**
     * list or watch objects of kind Event

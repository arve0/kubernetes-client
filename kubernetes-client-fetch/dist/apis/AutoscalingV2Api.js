...
exports.AutoscalingV2Api = void 0;
const runtime = require("../runtime");
const models_1 = require("../models");
/**
 *
 */
class AutoscalingV2Api extends runtime.BaseAPI {
    /**
    ...
    createNamespacedHorizontalPodAutoscalerRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: models_1.V2HorizontalPodAutoscalerToJSON(requestParameters.body),
            });
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V2HorizontalPodAutoscalerFromJSON(jsonValue));
        });
    }
    /**
     * create a HorizontalPodAutoscaler
    ...
    listHorizontalPodAutoscalerForAllNamespacesRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.V2HorizontalPodAutoscalerListFromJSON(jsonValue));
        });
    }
    /**
     * list or watch objects of kind HorizontalPodAutoscaler
